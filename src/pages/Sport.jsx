...
// Ex-page d'accueil, devenue la page "Le sport" (voir Home.jsx, desormais la page d'accroche) --
// panorama de la croissance ATHX (participation, calendrier, empreinte geographique, fidelite,
// comparaison HYROX). Contenu et logique inchanges, seul l'ajout ci-dessous (affiliation
        ...
        <div className="container">
          <Reveal className="about-block">
            <div className="about-block-text">
              ...
              {/* Affiliation CrossFit annoncee mi-septembre 2026 (couverture presse du 17/09/2026,
                  cf. The Barbell Spin / NewsBreak) -- aucune source officielle (ATHX ni CrossFit)
                  ne publie de jour precis, donc on cite le mois, pas un jour invente. */}
